...
const NACard = () => {
    return (
        <>
            <div className='w-full h-56 rounded-[3px] border-[2px] border-blk my-[12px] after: cursor-pointer transition-all ease-in-out duration-[0.1s] hover:drop-shadow-hoverShadow'>
