        ...
        <>
            <div className='w-full py-3 px-5 lg:px-56 border-b-blk border-[1px]'>
                <div className='flex flex-row justify-between items-center h-full'>
                    ...
                    <div className='hidden lg:flex flex-row w-full h-full justify-end items-center gap-x-5 font-bold text-blk' style={window.location.pathname === "/terms-and-conditions" || window.location.pathname === "/privacy-policy" ? { display: "none" } : { display: "flex" }}>
