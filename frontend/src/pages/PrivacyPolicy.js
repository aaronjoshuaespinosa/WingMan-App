...
import { HeroFooter, HeroNav } from '../components'

const PrivacyPolicy = () => {
  return (
    <div className='font-space'>
      <HeroNav />
      <div className='flex flex-col justify-center w-full my-10 px-5 lg:px-56'>
        <span className='font-bold text-4xl text-center w-full'>Privacy Policy</span><br />
        <p>This Privacy Policy describes Our policies and procedures on the collection,
          ...
          <br /><br />
          <p className='font-bold text-2xl text-center w-full'>Interpretation and Definitions</p>
          <hr className='h-[0.2rem] bg-light-gry' />
          <br /><br />
          <b>Interpretation</b>
          <br /><br />
          ...
          * Company (referred to as either "the Company", "We", "Us" or "Our" in this
          Agreement) refers to EyedOwl Organization, Cavite.
          <br /><br />
          ...
          * Usage Data refers to data collected automatically, either generated by the
          ...
          <br /><br />
          * Website refers to Wingman, accessible from https://wingman-
          app.vercel.app
          <br /><br />
          * You means the individual accessing or using the Service, or the company,
          ...
          <br /><br /><br />
          <p className='font-bold text-2xl text-center w-full'>Collecting and Using Your Personal Data</p>
          <hr className='h-[0.2rem] bg-light-gry' />
<br/><br/>
...
<br/><br/>
  * By email: charles.camantigue@cvsu.edu.ph</p>
    </div>
    <HeroFooter />
    </div>
  )
